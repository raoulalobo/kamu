...
import FichesMedicalesListItem from './FichesMedicalesListItem';


export class FichesMedicalesList extends React.Component{
    componentDidMount() {
                ...
                <Table selectable singleLine>
                    <Table.Header>
                        <Table.Row>
                            ...
                            <Table.HeaderCell>Ordonnance</Table.HeaderCell>
